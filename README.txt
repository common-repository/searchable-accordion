...
Donate link: http://nafsin.info
Tags: tinymce, editor, accordion
...
A tiny plugin to create accordion (directly from the editor)
...
1. Preview in the editor.
2. Inserting model window
3. The output
